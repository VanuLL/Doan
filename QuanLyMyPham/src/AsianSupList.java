...
public class AsianSupList {
	private Scanner sc = new Scanner(System.in);
	private int n, x;
	private String f;
	private AsianSup[] ds = new AsianSup[n];
	public AsianSupList() {
		super();
	}
	...
	public AsianSup[] getDs() {
		return ds;
	}
	public void setDs(AsianSup[] ds) {
		this.ds = ds;
	}
	public void add() {
	...
	public void doc(){
		...
		try {
			FileReader fr=new FileReader("AsianSup.txt");
	        ...
	        while(true) {
	        	...
	        	if (st == null) {
	        		...
	        		ds[count-1] = new AsianSup (s[0], s[1], s[2], s[3]);
	        		setN(count);
	        	}
	        }
	        if (v == 1) {
	...
	public void ghi() {
		// TODO Auto-generated method stub
			try {
				FileWriter fw = new FileWriter("AsianSup.txt");
	...
	public static void main(String[] args) {
		AsianSupList o = new AsianSupList();
		o.inList();
		o.ghi();
		o.tkTongChiPhi();
	}
